...
public class viewAvailable extends javax.swing.JFrame {
    ...
    public viewAvailable() {
     ...
     public void showRecord(){ 
        ...
        try{
                ...
                String sql = "SELECT * FROM REGISTRATION where status= 'NO' && category='SALE'";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 68, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 119, 1132, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(565, 557, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/all pages background.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
          MessageFormat header = new MessageFormat("Car List");
